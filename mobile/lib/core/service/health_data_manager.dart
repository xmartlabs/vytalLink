...
class HealthDataManager {
  ...
  Future<List<HealthDataPoint>> _fetchHealthDataPoints(
    ...
    while (currentStart.isBefore(endTime)) {
      ...
      // Note: if the health plugin uses inclusive end ranges, this may include
      // the boundary point in both batches. Monitor for duplicates if
      // unexpected data points appear at batch boundaries.
