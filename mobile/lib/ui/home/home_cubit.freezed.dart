...
class _$HomeStateImpl implements _HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(status: $status, connectionCode: $connectionCode, connectionWord: $connectionWord, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, status, connectionCode, connectionWord, errorMessage);
